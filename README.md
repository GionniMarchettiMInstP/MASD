...
### Input Data
The folder `fibrinogen_dataset` contains an overall number of 251  two-column files with extension .txt corresponding to UVRR, CD UV spectra of Fibrinogen in water solution alone, and in combination with either CNP or SiNP nanoparticles. The ...
